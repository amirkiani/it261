...
<html lang="en">
    ...
    <h1 class="center">Our Calculator</h1>
        ...
        <form action="" method="post">
            ...
            <select id="efficiency" name="fuel">
                <option disabled selected>Select Fuel Efficiency</option>
    ...
    <div class="box">
        <?php 
            ...
            if (is_null($cost) && count($error) > 0 ) { 
                foreach ($error as $err) {
                    echo '<div class="box">
                    <h2 style="color:red" class="center">Please fill out the '.$err.' </h2>    </div>';
                }
                
        
            } elseif(!is_null($cost) && !is_null($submit)) {
                echo '<h1 class="center" style="color:red">Calculator Results</h1>';
                echo '<p>'.$name.', You have driven <b>'.$miles .' miles</b></p><br/>';
                echo '<p>Your vehicle has an efficiency rating of <b>'.$eff .' miles per gallon</b></p><br/>';
                echo '<p>Your total cost for gas will be <b>$'.$cost .' dollars</b></p><br/>';
                echo '<p>You will be driving a total of <b>'.number_format($time, 2, '.', '') .' days</b></p>';
            } else {
                // do nothing
            }
